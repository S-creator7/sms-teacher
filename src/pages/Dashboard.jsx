          ...
          <div className="flex items-center justify-end gap-3 flex-wrap">
            <div className="flex items-center gap-3 p-2 rounded-xl border border-gray-200 bg-white shadow-sm w-full sm:w-auto">
              ...
              <button
                ...
                disabled={attBusy}
                className={`group inline-flex items-center gap-2 px-3 py-2 rounded-xl text-sm font-semibold shadow-md transition-all disabled:opacity-60 disabled:cursor-not-allowed ${isLoggedInToday && !hasLoggedOut
                              ...
                              <div className="mt-3">
                                ...
                                <div className="mt-3 flex items-center justify-between gap-3">
                                  ...
                                  <button
                                    ...
                                    className={`text-sm px-3 py-1.5 rounded-lg border font-medium transition-colors duration-200 ${n.is_read
            ...
            {loading ? (
              ...
              classrooms.map((c) => (
                <div key={`${c.classroom_id}-${c.section_id}`} className="flex items-center justify-between p-4 border border-gray-200 rounded-xl gap-4 hover:bg-gray-50 transition-colors duration-150">
                  ...
                  <span className={`text-sm font-semibold px-3 py-2 rounded-lg flex-shrink-0 ${attendanceToday[c.classroom_id]
          ...
          <div className="px-5 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">Overview of ticket statistics and trends</p>
              </div>
